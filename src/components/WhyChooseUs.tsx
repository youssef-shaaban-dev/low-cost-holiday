...
export default function WhyChooseUs() {
  const benefits: Benefit[] = [
    {
      title: "أرخص سعر رحلات في مصر",
      description: "نحن نضمن لك تكلفة اقتصادية لا تُقارن. نوفر أسعاراً مخفضة للرحلات الجوية المباشرة وحجوزات الفنادق بالجملة لننقل التوفير إليك مباشرة.",
    ...
    },
    {
      ...
      description: "نساعدك في إعداد وتجهيز كافة المستندات المطلوبة للتأشيرة التركية والتأشيرة التونسية، مع متابعة مستمرة لضمان صدورها في أسرع وقت وبنسبة قبول عالية.",
