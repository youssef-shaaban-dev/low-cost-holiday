...
export default function Header() {
  ...
  return (
    ...
    >
      ...
      <div
        className={`fixed inset-y-0 right-0 z-40 w-full max-w-xs bg-brand-blue/98 backdrop-blur-lg shadow-2xl p-6 border-l border-white/10 transition-transform duration-300 transform md:hidden ${
